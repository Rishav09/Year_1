...
def train(n_epochs, loaders, model, optimizer, criterion, use_cuda):
    ...
    for epoch in range(1, n_epochs+1):
        ...
        if valid_loss <= valid_loss_min:
            ...
            torch.save(model.state_dict(), '/home/rxs1576/Experiments/triton_models/Parallel_dict_all_transform.pt')
            torch.save(model,'/home/rxs1576/Experiments/triton_models/Parallel_complete_all_transform.pt')
            valid_loss_min = valid_loss
